...
const cards = {
  characters: {
   ...
   "Grandmaster": new Card("The Grandmaster", "Time works real different around these parts.", "https://upload.wikimedia.org/wikipedia/en/thumb/0/00/Jeff_Goldblum_as_the_Grandmaster_in_Thor_Ragnarok.jpg/170px-Jeff_Goldblum_as_the_Grandmaster_in_Thor_Ragnarok.jpg", 50 "Rare"),
    ...
    "StarLord": new Card("Star Lord", "You said it yourself. We're the Guardians of the Galaxy.", "https://vignette.wikia.nocookie.net/marvelcinematicuniverse/images/9/96/Star-Lord_AIW_Profile.jpg/revision/latest/scale-to-width-down/310?cb=20180518211942", 50, "Rare"),
    "BlackWidow": new Card("Black Widow", "Hey, big guy. Sun's getting real low.", "https://ksassets.timeincuk.net/wp/uploads/sites/55/2018/02/Black-Widow-Avengers-920x584.jpg", 20, "Common"),
    "Drax": new Card("Drax", "There are two types of beings in the universe. Those who dance, and those who do not.", "https://images.indianexpress.com/2018/05/avengers-drax.jpg", 40, "Uncommon"),
    "CaptainAmerica": new Card("Captain America", "We don't trade lives here", "https://i.pinimg.com/originals/99/fd/97/99fd97e6a3ab69932785110bebb7e411.jpg", 60, "Rare"),
    "CaptainAmerica2": new Card("Captain America", "We don't trade lives here", "http://moviehole.net/img/captain-america-avengers-infinity-war.jpg", 65, "Rare"),
    "Hawkeye": new Card("Hawkeye", "What? You didn't see that coming?", "https://cdn.flickeringmyth.com/wp-content/uploads/2017/08/hawkeye-jeremy-renner-600x338.jpg", 15, "Common"),
    "Odin": new Card("Odin", "Malekith was vanquished and the Aether was no more, or so we were led to beleive...", "http://digitalspyuk.cdnds.net/18/24/980x490/landscape-1528905527-odin-thor-cornation.jpg", 75, "Epic"),
  },
  items: {
